...
#import "../RelayClass/YKInboxViewController.h"
...
- (void)yk_configurePage {
    ...
    self.segmentTitles = @[[YKSigilForge yk_unveil:@"BJOCwYUjx2NBenty6NZ6Xw=="], @"Collections"];
...
- (void)yk_setupViews {
    ...
    UILabel *inboundTitleLabel = [self yk_captionLabelWithText:[YKSigilForge yk_unveil:@"zp3IYTxq3Gjb3hnCBF06xA=="]];
    UILabel *outboundValueLabel = [self yk_countLabelWithText:[NSString stringWithFormat:@"%ld", (long)self.yk_outboundCount]];
    UILabel *outboundTitleLabel = [self yk_captionLabelWithText:[YKSigilForge yk_unveil:@"mQ3A5aWGAwIw5fwUx6iQZw=="]];
    ...
    UIButton *linkBtn = [self yk_outlineButtonWithTitle:[YKSigilForge yk_unveil:@"XloucoaA2i7z2gsuWyglLg=="]];
    ...
    UIButton *chatButton = [self yk_filledButtonWithTitle:[YKSigilForge yk_unveil:@"LxxYycmiK3MNJKtiotJzPg=="]];
...
- (void)yk_refreshLinkButton {
    ...
    if (linked) {
        [self.yk_linkButton setTitle:[YKSigilForge yk_unveil:@"TS+hCnu1QPAtWym+i+DnWQ=="] forState:UIControlStateNormal];
        ...
        [self.yk_linkButton setTitle:[YKSigilForge yk_unveil:@"XloucoaA2i7z2gsuWyglLg=="] forState:UIControlStateNormal];
