...
#import "../LoginandReClass/YKSparkBooth.h"
...
- (void)yk_setupViews {
    ...
    titleLabel.text = [YKSigilForge yk_unveil:@"0rRTc5Xifg5v7G59kIjlYw=="];
...
- (void)yk_beginSkuClaim:(NSString *)productId {
    ...
    [[YKSparkBooth sharedBooth] yk_claimSku:productId
        ...
        if (error != nil) {
            NSString *msg = error.localizedDescription.length > 0 ? error.localizedDescription : [YKSigilForge yk_unveil:@"5Vs4kLbF63El4SwV9yncpg=="];
