...
- (void)yk_refreshAccountHeader {
    ...
    if ([personaId isKindOfClass:NSString.class] && personaId.length > 0) {
        ownerKey = personaId;
    } else if (![YKAccountVault yk_isReviewMailbox:[vault yk_activeMailbox] ?: @""]) {
