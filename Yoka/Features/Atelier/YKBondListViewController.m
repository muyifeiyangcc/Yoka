...
- (void)yk_setupChrome {
    ...
    titleLabel.text = (self.yk_kind == YKBondListKindInbound) ? [YKCipherLoom yk_unfurl:@"zp3IYTxq3Gjb3hnCBF06xA=="] : [YKCipherLoom yk_unfurl:@"mQ3A5aWGAwIw5fwUx6iQZw=="];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.yk_kind == YKBondListKindOutbound) {
        title = [YKCipherLoom yk_unfurl:@"TS+hCnu1QPAtWym+i+DnWQ=="];
        filled = YES;
    } else {
        title = linked ? [YKCipherLoom yk_unfurl:@"TS+hCnu1QPAtWym+i+DnWQ=="] : [YKCipherLoom yk_unfurl:@"XloucoaA2i7z2gsuWyglLg=="];
        filled = linked;
    }
