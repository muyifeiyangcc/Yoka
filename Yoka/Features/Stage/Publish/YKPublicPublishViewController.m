...
- (void)yk_setupViews {
    ...
    [postButton setTitle:[YKCipherLoom yk_unfurl:@"nUDz1MN7enUF4l9g/i/fmg=="] forState:UIControlStateNormal];
...
- (NSString *)yk_publishOwnerKey {
    ...
    if ([YKRosterVault yk_isReviewMailbox:mailbox]) {
...
- (void)yk_dispatchEntryTapped:(UIButton *)sender {
    ...
    [YKCenterToast yk_showLoadingInView:self.view performAfterDelay:0.7 work:^{
        ...
        [YKCenterToast yk_showNotice:[YKCipherLoom yk_unfurl:@"JKASYqgvjpEMBfv9FzlXsA=="] inView:self.view];
