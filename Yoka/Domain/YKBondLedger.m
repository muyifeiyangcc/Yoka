...
static NSString * const kYKBondOutboundMapKey = @"yoka.roster.bondOutbound.r1";
static NSString * const kYKBondLinksBackMapKey = @"yoka.roster.bondInbound.r1";
static NSString * const kYKBondPrimedOwnersKey = @"yoka.roster.bondPrimed.r1";
